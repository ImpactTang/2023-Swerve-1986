...
public class ScoreLowCmd extends SequentialCommandGroup{
    ...
    public ScoreLowCmd(ArmRotationSubsystem armRotationSubsystem, ArmExtensionSubsystem armExtensionSubsystem, IntakeSubsystem intakeSubsystem){

        addCommands(
            new ParallelCommandGroup(
                new ExtendCmd(armExtensionSubsystem, Units.inchesToMeters(0.0)),
                new RotateCmd(armRotationSubsystem, Units.degreesToRadians(180.0))));
        addCommands(
