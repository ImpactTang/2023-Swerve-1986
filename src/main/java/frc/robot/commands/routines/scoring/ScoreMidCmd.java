...
public class ScoreMidCmd extends SequentialCommandGroup{
    ...
    public ScoreMidCmd(ArmRotationSubsystem armRotationSubsystem, ArmExtensionSubsystem armExtensionSubsystem, IntakeSubsystem intakeSubsystem){

        addCommands(
            new ParallelCommandGroup(
                new ExtendCmd(armExtensionSubsystem, Units.inchesToMeters(13.0)),
                new RotateCmd(armRotationSubsystem, Units.degreesToRadians(60.0))));
        addCommands(
